      ...
      <div className="flex items-center justify-between px-4 mb-4">
        ...
        <div className="flex items-center gap-4 text-white/80">
          ...
          <div className="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center relative">
            <Image src="https://www.image2url.com/r2/default/images/1776746397505-70a6816b-9461-432e-ba0f-7b379a057038.jpeg" alt="Developer Profile" fill sizes="32px" className="object-cover" />
          </div>
        </div>
      </div>
