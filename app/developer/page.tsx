        ...
        >
          ...
          <div className="relative w-48 h-48 mb-2">
            ...
            <div className="relative w-full h-full rounded-[50%_50%_40%_60%_/_60%_40%_50%_50%] overflow-hidden border-2 border-[#4ADE80]/20 z-10">
              <Image 
                src="https://www.image2url.com/r2/default/images/1776746397505-70a6816b-9461-432e-ba0f-7b379a057038.jpeg" 
                alt="Hidz Forum" 
                fill 
                sizes="192px"
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <h2 className="text-2xl font-bold text-white">Hidz Forum</h2>
          ...
          <div className="grid grid-cols-4 gap-3 w-full max-w-sm mb-4">
            ...
            <a href="https://whatsapp.com/channel/0029Vb7YXnZ2phHSrbTbUJ3S" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center gap-2 bg-[#1C1C1E] hover:bg-[#2C2C2E] p-4 rounded-2xl transition-colors">
          ...
          {/* Buy me a coffee */}
          <a 
            href="https://saweria.co/hidzforums"
            target="_blank"
